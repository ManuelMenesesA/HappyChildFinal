...
<body id="page-top">
    ...
    <section class="page-section portfolio" id="portfolio">
        <div class="container">
            ...
            <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Ed.Fisica</h2>
            <!-- Icon Divider-->
...
if (isset($_POST['agregar'])) {
  ...
  $link = $_POST['link'];
  $query= "INSERT INTO edfisica(titulo, descripcion,link) VALUES ('$title', '$description','$link')";
  $result = mysqli_query($conn, $query);
  if(!$result) {
    die("Query Failed.");
  }
